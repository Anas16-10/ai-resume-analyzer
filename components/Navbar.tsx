            ...
            <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <Link
                        ...
                        target="_blank"
                        className={cn(buttonVariants({ variant: "ghost", size: "sm" }), "hidden sm:flex text-slate-600")}
                    >
                        About
                    </Link>
                    <Link
                        ...
                        target="_blank"
                        className={cn(buttonVariants({ variant: "outline", size: "sm" }), "gap-2 border-slate-200 text-slate-700 hover:bg-slate-50")}
                    >
